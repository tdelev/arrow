...
// arrow.core.OptionMonadErrorInstanceImplicits$instance$1@4ef5d9f0
```

```kotlin
monadError<ForTry, Throwable>()
// arrow.core.TryMonadErrorInstanceImplicits$instance$1@459b249a
```

```kotlin
monadError<EitherPartialOf<NukeException>, NukeException>()
// arrow.core.EitherMonadErrorInstanceImplicits$instance$1@1841c0b1
```
